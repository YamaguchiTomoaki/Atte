    ...
    <div class="register-form__inner">
        <form class="register-form" action="/register" method="post">
            ...
            <div class="register-form__group">
                <input class="register-form__input" type="text" name="name" placeholder="名前" value="{{ old('name') }}">
            ...
            <div class="register-form__group">
                <input class="register-form__input" type="email" name="email" placeholder="メールアドレス" value="{{ old('email') }}">
                <p class="register-form__error-message">
                    @error('email')
                    {{ $message }}
                    @enderror
